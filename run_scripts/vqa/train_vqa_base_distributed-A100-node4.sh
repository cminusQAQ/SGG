...
export MASTER_PORT=8735
# The rank of this worker, should be in {0, ..., WORKER_CNT-1}, for single-worker training, please set to 0
export RANK=0

data_dir=/data/cminus/datasets/OFA_data/sgg
...
ans2label_file=${data_dir}/${split}/50_way_ans2label.pkl
restore_file=../../SGG_0909_OFA_base.pt
#restore_file=/data/private/yutianyu/OFA/run_scripts/vqa/coco_out_of_VG_best_checkpoint.pt
#restore_file=/data/private/yutianyu/OFA/run_scripts/vqa/vqa_checkpoints/50_way/1_B20_A1_E5_0.05_5e-5_480/checkpoint_best.pt
...
validate_interval=1
validate_interval_updates=5000000
      ...
      for update_freq in {1,}; do
        ...
        for lr in {5e-4,}; do
          ...
          for patch_image_size in {480,}; do
            ...
            exp_tag=50_way_cache_test_logits
            ...
            CUDA_VISIBLE_DEVICES=3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=${GPUS_PER_NODE} --nnodes=${WORKER_CNT} --node_rank=${RANK} --master_addr=${MASTER_ADDR} --master_port=${MASTER_PORT} --use_env ../../train.py \
              ${data} \
