...
# %%
train_rel_data = json.load((split_dir / 'sup_train_50.json').open())
train_info = json.load((split_dir / 'sup_info_50.json').open())
...
# %%
test_data = json.load((split_dir / 'test_data.json').open())
test_p_counter = collect_test_samples(test_data, vg_dict, 'test', 0)

# %%
val_data = json.load((split_dir / 'val_data.json').open())
val_p_counter = collect_test_samples(val_data, vg_dict, 'val', 500)
